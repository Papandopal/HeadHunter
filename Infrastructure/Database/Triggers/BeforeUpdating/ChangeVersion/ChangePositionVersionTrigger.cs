...
{
    public class ChangePositionVersionTrigger : IBeforeSaveTrigger<Position>
    {
        Task IBeforeSaveTrigger<Position>.BeforeSave(ITriggerContext<Position> context, CancellationToken cancellationToken)
        {
